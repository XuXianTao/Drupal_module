...
use Drupal\webform_templates\Controller\WebformTemplatesController;
...
class WebformTemplateResource extends ResourceBase
{
    ...
    /**
     * Constructs a new WebformTemplateResource object.
     *
    ...
    public function get()
    {
        ...
        $result = _webform_template_rest_resource_construct($entities, $limit, $page, $only_cover);
